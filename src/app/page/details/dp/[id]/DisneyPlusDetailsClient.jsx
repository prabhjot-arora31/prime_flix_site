...
export default function DisneyPlusDetailsClient({ details, episodes, id }) {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(https://imgcdn.media/hs/v/166/${id}.jpg)`,
      }}
    >
      ...
      <div className="w-full min-h-screen bg-gradient-to-b from-black/80 via-black/70 to-black/90 backdrop-blur-sm">
        ...
        <div className="max-w-7xl mx-auto p-6 pt-8 flex flex-col sm:flex-row gap-8 items-center sm:items-start">
          ...
          {/* Details */}
          <div className="w-full sm:w-auto sm:mt-0 max-w-full overflow-x-auto p-4">
            {/* Title */}
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {details.genre?.split(",").map((genre, index) => (
                  <span
                    key={index}
                    className="bg-gray-800 text-gray-200 px-3 py-1 rounded-full text-sm hover:bg-gray-700 transition duration-200"
                  >
                    {genre.trim()}
                  </span>
                ))}
